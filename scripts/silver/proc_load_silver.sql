...
declare @start_time datetime,@end_time datetime,@begin_time datetime, @stop_time datetime
begin
	begin try
		...
		print 'Total Load Duration ' + cast(datediff(second,@begin_time,@stop_time) as nvarchar) + ' seconds'
		end try
		begin catch
